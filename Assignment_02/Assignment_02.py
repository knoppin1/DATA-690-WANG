...
def minimum(data):
    '''minimum - Returns minimum value in a given list'''
    min_integer = data[0]
    for num in data:
        if num < min_integer:
            min_integer = num
...
def maximum(data):
    '''maximum - Returns maximum value in a given list'''
    max_integer = data[0]
    for num in data:
        if num > max_integer:
            max_integer = num
...
def integer_range(data):
    '''integer_range - Return a tuple containing the minimum and maximum values from a given list'''
    return minimum(data), maximum(data) 

def total(data):
    '''total - Return the sum of values in a given list'''
    total = 0
    for num in data:
        total += num
    return total
...
def variance(data):
    ...
    variance = total(deviations) / len(data)
    return variance
